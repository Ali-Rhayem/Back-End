...
// Handle PUT and PATCH methods for updating flight
if ($_SERVER['REQUEST_METHOD'] === "PUT" || $_SERVER['REQUEST_METHOD'] === "PATCH") {
    ...
    // Bind parameters
    $stmt->bind_param('siisssii', $flight_number, $departure_airport_id, $arrival_airport_id, $departure_time, $arrival_time, $available_seats, $price, $flight_id);
